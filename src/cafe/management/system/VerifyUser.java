...
public class VerifyUser extends javax.swing.JFrame {
    ...
    public void getAllRecords(String email) {
        ...
        while (itr.hasNext()) {
            ...
            if (!userObj.getEmail().equals("admin@gmail.com")) {
                dtm.addRow(new Object[]{userObj.getId(), userObj.getName(), userObj.getEmail(), userObj.getMobileNumber(), userObj.getAnswer(), userObj.getStatus()});
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 13, 127, -1));
        ...
        getContentPane().add(btnExit, new org.netbeans.lib.awtextra.AbsoluteConstraints(1271, 14, -1, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Search Email");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(426, 115, -1, -1));
        ...
        getContentPane().add(txtSearchEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(529, 112, 300, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Email", "Mobile", "Address", "Status"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(27, 160, 1307, 467));

        jLabel3.setFont(new java.awt.Font("Bell MT", 1, 36)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("*Click on row to change user status");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(397, 660, 573, -1));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        int a = JOptionPane.showConfirmDialog(null, "Do you want to change the status of "+email+"?","selected",JOptionPane.YES_NO_OPTION);
        if(a==0){
